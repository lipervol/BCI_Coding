...
class Game(object):
    def __init__(self):
        ...
        self.font = pygame.font.SysFont("./res/font/cambriai.ttf", 60)
    ...
    def __create_sprites(self):
        self.hero = Hero("./res/hero.png")
        self.hero_group = pygame.sprite.Group()
        self.hero_group.add(self.hero)

        self.enemy = Enemy("./res/enemy.png")
        ...
        if self.enemy.status == 1:
            if self.enemy.break_idx // 4 < 9:
                self.enemy.image = pygame.transform.scale(
                    pygame.image.load("./res/break/" + str(self.enemy.break_idx // 4) + ".png"), (150, 150))
